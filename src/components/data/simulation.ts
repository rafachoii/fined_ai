...
import type { FormStepPorps } from "../../features/Simulation/FormStep";

export const simulationFormSteps: FormStepPorps[] = [
    {
        id: 'income',
        icon: PiggyBank,
        title: 'Rneda mensal bruta',
    ...
    },
    {
        ...
        question: 'Você tem algum valor comprometido ou empréstimos mensalmente?',
        inputProps: {
